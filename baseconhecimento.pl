...
linha(auber, chateletleshalles).
linha(chateletleshalles, auber).

linha(chateletleshalles, garedelyon).
linha(garedelyon, chateletleshalles).


linha(garedelyon, natlon).
linha(natlon, garedelyon).

linha(natlon, vincennes).
linha(vincennes, natlon).
